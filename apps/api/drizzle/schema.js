...
exports.services = exports.companies = exports.users = exports.categoryEnum = exports.serviceStatusEnum = exports.roleEnum = void 0;
...
exports.services = (0, pg_core_1.pgTable)('services', {
    ...
    companyId: (0, pg_core_1.text)('company_id').notNull().references(() => exports.companies.id),
